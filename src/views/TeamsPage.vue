        ...
        <v-card-text>
          ...
          <v-row v-else class="mt-4" dense>
            <v-col v-for="(team, idx) in sortedTeams" :key="team.id" cols="12">
              <v-card
                :color="team.id === myTeamId ? 'primary' : 'surface'"
                class="pa-4"
                elevation="2"
              >
                <div class="d-flex justify-space-between align-center">
                  ...
                  <div class="text-right">
                    ...
                    <div class="text-caption">{{ team.member_count }} Mitglieder</div>
                  </div>
                  <div class="text-right font-weight-bold">{{ team.total_km ?? 0 }} km</div>
                </div>
              </v-card>
            </v-col>
          </v-row>
          ...
          <div v-if="!myTeamId" class="mt-6">
            <v-btn color="primary" @click="goToCreateTeam"> ➕ Team erstellen </v-btn>
          </div>
