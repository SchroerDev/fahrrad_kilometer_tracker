  ...
  <v-main>
    <v-container fluid>
      <v-card class="pa-4" elevation="4">
        ...
        <v-card-subtitle
          >Du kannst ein Teammitglied per E-Mail einladen oder den Beitrittslink
          teilen.</v-card-subtitle
        >
        ...
        <v-card-text>
          ...
          <v-btn class="mt-4" color="grey" @click="goBack">Zurück zum Team</v-btn>
        </v-card-text>
      </v-card>
    </v-container>
  </v-main>
